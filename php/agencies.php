...
<head>
    ...
    <title>Agencies | iProperty</title>
        ...
        <div class="container">
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-8 text-center-sm">
                    <h3 class="text-white text-uppercase text-bold-700 m-bottom-0">Agencies</h3>
                </div>
            ...
            <div class="row">
                ...
                <ul class="clearfix full-width" data-plugin-masonry>
                    ...
                    <li class="col-lg-6 col-md-12">
                        <div class="agency bg-white box-shadow-1 box-shadow-3-hover p-top-30 p-left-30 p-right-30 m-bottom-30 border-1 border-solid border-light">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">Real Estate</a></h4>
                                ...
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">The Big City</a></h4>
                                ...
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">SK Home</a></h4>
                                ...
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">LUXURY Builders</a></h4>
                                ...
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">Real City</a></h4>
                        ...
                        <div class="agency bg-white box-shadow-1 box-shadow-3-hover p-top-30 p-left-30 p-right-30 m-bottom-30 border-1 border-solid border-light">
                            <div class="row">
                                <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12 p-bottom-15">
                                    <div class="agency-media position-relative">
                                        <a class="d-block" href="#">
                                            <img class="full-width" src="assets/images/clients/logo-7.png">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">Shield House</a></h4>
                                            <p>253 Lake Washington, USA</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="agency bg-white box-shadow-1 box-shadow-3-hover p-top-30 p-left-30 p-right-30 m-bottom-30 border-1 border-solid border-light">
                            <div class="row">
                                <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12 p-bottom-15">
                                    <div class="agency-media position-relative">
                                        <a class="d-block" href="#">
                                            <img class="full-width" src="assets/images/clients/logo-8.png">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">Home Business</a></h4>
                                            <p>154 Drive, New York</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="agency bg-white box-shadow-1 box-shadow-3-hover p-top-30 p-left-30 p-right-30 m-bottom-30 border-1 border-solid border-light">
                            <div class="row">
                                <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12 p-bottom-15">
                                    <div class="agency-media position-relative">
                                        <a class="d-block" href="#">
                                            <img class="full-width" src="assets/images/clients/logo-9.png">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">Arrow House</a></h4>
                                            <p>110 Lake, United Kingdom</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="agency bg-white box-shadow-1 box-shadow-3-hover p-top-30 p-left-30 p-right-30 m-bottom-30 border-1 border-solid border-light">
                            <div class="row">
                                <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12 p-bottom-15">
                                    <div class="agency-media position-relative">
                                        <a class="d-block" href="#">
                                            <img class="full-width" src="assets/images/clients/logo-10.png">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-md-9 col-sm-8 col-xs-12 p-bottom-15">
                                    <div class="agency-section position-relative">
                                        <div class="agency-data m-top-0 m-bottom-20">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4 class="text-uppercase text-bold-700"><a href="#">Perfect Home City</a></h4>
                                            <p>103 Occidental Washington USA</p>
                                        </div>
                                    </div>
                                </div>
