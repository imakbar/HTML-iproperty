...
<head>
    ...
    <title>Register | iProperty</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a class="btn btn-white text-bold-600 text-spacing-5 text-uppercase text-size-15 m-bottom-10 rounded-0 active box-shadow-3 p-top-12 p-bottom-12 p-left-20 p-right-20" href="register.php">Register</a>
                                </li>
                                <li class="list-inline-item">
                            ...
                            <div class="tab-pane bg-white p-top-30 p-bottom-30 p-left-30 p-right-30 box-shadow-1">
                                <h3 class="text-bold-700 text-uppercase m-bottom-20">Register</h3>
                                <form>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control form-control-lg rounded-0 bg-light-5 text-size-14" placeholder="Confirm Password">
                                        </div>
                                    </div>
                                    <div class="form-group m-top-30">
                                        <input type="submit" class="btn btn-base rounded-0 text-bold-600 text-spacing-5 text-uppercase text-size-13 m-bottom-10 p-top-12 p-bottom-12 p-left-20 p-right-20" value="Register">
                                    </div>
                                    <div class="clearfix">
                                        <a class="text-base text-base-white-hover" href="login.php">Already have account?</a>
                                    </div>
                                </form>
                            </div>
                        </div>
