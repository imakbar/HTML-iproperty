...
<head>
    ...
    <title>Agents - Fullwidth | iProperty</title>
        ...
        <div class="container">
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-8 text-center-sm text-center-md">
                    <h3 class="text-white text-uppercase text-bold-700 m-bottom-0">Agents - Fullwidth</h3>
                </div>

                <div class="col-md-4 text-right text-center-sm text-center-md">
                    <ol class="breadcrumb bg-white rounded-0">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Agents - Fullwidth</li>
                    </ol>
                </div>
            ...
            <div class="row m-bottom-30">
                ...
                <div class="col-md-12">
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 match-height vcenter">
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    ...
                                    <ul class="icon-list m-bottom-25">
                                        <li><i class="btn btn-base fa fa-flag"></i> Buying Agent</li>
                                        <li><i class="btn btn-base fa fa-envelope"></i> david@iproperty.com</li>
                                        <li><i class="btn btn-base fa fa-phone"></i> (123) 456-6789</li>
                                    </ul>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Alex Brain</a></h3>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Fred Kevin</a></h3>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Angelina Jolie</a></h3>
                                        <p>253 Lake Washington, USA</p>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Fusce elementum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo vamus suscipit molestie vestibulum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo.</p>
                                    </div>
                                    <ul class="icon-list m-bottom-25">
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Twin Smith</a></h3>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Mark David</a></h3>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 match-height vcenter">
                                <div class="agent-media position-relative">
                                    <a class="d-block" href="#">
                                        <img alt="..." class="full-width" src="assets/images/agents/agent-7.jpg">
                                    </a>
                                    <div class="media-data">
                                        <div class="position-top">
                                            <div class="badge badge-base text-white pull-left p-top-8 p-right-12 p-bottom-8 p-left-12 rounded-0">25 Properties</div>
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Herman Miller</a></h3>
                                        <p>103 Occidental Washington USA</p>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Fusce elementum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo vamus suscipit molestie vestibulum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo.</p>
                                    </div>
                                    <ul class="icon-list m-bottom-25">
                                        <li><i class="btn btn-base rounded-0 fa fa-flag"></i> Selling Agent</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-envelope"></i> herman@iproperty.com</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-phone"></i> (123) 456-6789</li>
                                    </ul>
                                    <ul class="social-icons">
                                        <li>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 match-height vcenter">
                                <div class="agent-media position-relative">
                                    <a class="d-block" href="#">
                                        <img alt="..." class="full-width" src="assets/images/agents/agent-8.jpg">
                                    </a>
                                    <div class="media-data">
                                        <div class="position-top">
                                            <div class="badge badge-base text-white pull-left p-top-8 p-right-12 p-bottom-8 p-left-12 rounded-0">14 Properties</div>
                                        </div>
                                        <div class="position-bottom">
                                            <a class="btn btn-white text-bold-600 text-spacing-5 text-size-13 pull-left line-height-18 rounded-0" href="#">
                                                <i class="fa fa-building-o m-right-4"></i>
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Britney Smith</a></h3>
                                        <p>110 Lake, United Kingdom</p>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Fusce elementum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo vamus suscipit molestie vestibulum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo.</p>
                                    </div>
                                    <ul class="icon-list m-bottom-25">
                                        <li><i class="btn btn-base rounded-0 fa fa-flag"></i> Selling Agent</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-envelope"></i> britney@iproperty.com</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-phone"></i> (123) 456-6789</li>
                                    </ul>
                                    <ul class="social-icons">
                                        <li>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 match-height vcenter">
                                <div class="agent-media position-relative">
                                    <a class="d-block" href="#">
                                        <img alt="..." class="full-width" src="assets/images/agents/agent-9.jpg">
                                    </a>
                                    <div class="media-data">
                                        <div class="position-top">
                                            <div class="badge badge-base text-white pull-left p-top-8 p-right-12 p-bottom-8 p-left-12 rounded-0">15 Properties</div>
                                        </div>
                                        <div class="position-bottom">
                                            <a class="btn btn-white text-bold-600 text-spacing-5 text-size-13 pull-left line-height-18 rounded-0" href="#">
                                                <i class="fa fa-building-o m-right-4"></i>
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Maria David</a></h3>
                                        <p>253 Lake Washington, USA</p>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Fusce elementum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo vamus suscipit molestie vestibulum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo.</p>
                                    </div>
                                    <ul class="icon-list m-bottom-25">
                                        <li><i class="btn btn-base rounded-0 fa fa-flag"></i> Buying Agent</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-envelope"></i> maria@iproperty.com</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-phone"></i> (123) 456-6789</li>
                                    </ul>
                                    <ul class="social-icons">
                                        <li>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 match-height vcenter">
                                <div class="agent-media position-relative">
                                    <a class="d-block" href="#">
                                        <img alt="..." class="full-width" src="assets/images/agents/agent-10.jpg">
                                    </a>
                                    <div class="media-data">
                                        <div class="position-top">
                                            <div class="badge badge-base text-white pull-left p-top-8 p-right-12 p-bottom-8 p-left-12 rounded-0">12 Properties</div>
                                        </div>
                                        <div class="position-bottom">
                                            <a class="btn btn-white text-bold-600 text-spacing-5 text-size-13 pull-left line-height-18 rounded-0" href="#">
                                                <i class="fa fa-building-o m-right-4"></i>
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Miller Herman</a></h3>
                                        <p>154 Drive, New York</p>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Fusce elementum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo vamus suscipit molestie vestibulum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo.</p>
                                    </div>
                                    <ul class="icon-list m-bottom-25">
                                        <li><i class="btn btn-base rounded-0 fa fa-flag"></i> Selling Agent</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-envelope"></i> miller@iproperty.com</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-phone"></i> (123) 456-6789</li>
                                    </ul>
                                    <ul class="social-icons">
                                        <li>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 match-height vcenter">
                                <div class="agent-media position-relative">
                                    <a class="d-block" href="#">
                                        <img alt="..." class="full-width" src="assets/images/agents/agent-11.jpg">
                                    </a>
                                    <div class="media-data">
                                        <div class="position-top">
                                            <div class="badge badge-base text-white pull-left p-top-8 p-right-12 p-bottom-8 p-left-12 rounded-0">10 Properties</div>
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Andrew Man</a></h3>
                                        <p>221 Madison Seattle, USA</p>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Fusce elementum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo vamus suscipit molestie vestibulum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo.</p>
                                    </div>
                                    <ul class="icon-list m-bottom-25">
                                        <li><i class="btn btn-base rounded-0 fa fa-flag"></i> Selling Agent</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-envelope"></i> andrew@iproperty.com</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-phone"></i> (123) 456-6789</li>
                                    </ul>
                                    <ul class="social-icons">
                                        <li>
                    ...
                    <div class="agent bg-white box-shadow-1 box-shadow-2-hover m-bottom-30">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 match-height vcenter">
                                <div class="agent-media position-relative">
                                    <a class="d-block" href="#">
                                        <img alt="..." class="full-width" src="assets/images/agents/agent-12.jpg">
                                    </a>
                                    <div class="media-data">
                                        <div class="position-top">
                                            <div class="badge badge-base text-white pull-left p-top-8 p-right-12 p-bottom-8 p-left-12 rounded-0">3 Properties</div>
                                        </div>
                                        <div class="position-bottom">
                                            <a class="btn btn-white text-bold-600 text-spacing-5 text-size-13 pull-left line-height-18 rounded-0" href="#">
                                                <i class="fa fa-building-o m-right-4"></i>
                            ...
                            <div class="col-md-8 col-sm-12 match-height vcenter">
                                <div class="agent-section position-relative p-top-10 p-right-15 p-left-15 p-top-30-md p-bottom-25-md p-top-30-sm p-bottom-25-sm">
                                    <div class="m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">Peter Ruck</a></h3>
                                        <p>103 Occidental Washington USA</p>
                                        <p>Lorem ipsum dolor sit amet consectetur adipiscing elit. Fusce elementum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo vamus suscipit molestie vestibulum nulla vel pellentesque consequat ante nulla hendrerit arcu ac tincidunt mauris lacus sed leo.</p>
                                    </div>
                                    <ul class="icon-list m-bottom-25">
                                        <li><i class="btn btn-base rounded-0 fa fa-flag"></i> Buying Agent</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-envelope"></i> peter@iproperty.com</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-phone"></i> (123) 456-6789</li>
                                    </ul>
                                    <ul class="social-icons">
                                        <li>
