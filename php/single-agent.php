...
<head>
    ...
    <title>Single Agent | iProperty</title>
        ...
        <div class="container">
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-8 text-center-sm text-center-md">
                    <h3 class="text-white text-uppercase text-bold-700 m-bottom-0">Single Agent</h3>
                </div>

                <div class="col-md-4 text-right text-center-sm text-center-md">
                    <ol class="breadcrumb bg-white rounded-0">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Single Agent</li>
                    </ol>
                </div>
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-12 p-top-15 p-bottom-15">
                                <div class="agent-section position-relative">
                                    <div class="agent-data m-top-0 m-bottom-20">
                                        <h3 class="text-uppercase text-bold-700"><a href="#" class="text-base">David Smith</a></h3>
                                    ...
                                    <ul class="icon-list">
                                        ...
                                        <li><i class="btn btn-base rounded-0 fa fa-phone"></i> (123) 456-6789</li>
                                        <li><i class="btn btn-base rounded-0 fa fa-skype"></i> davidsmith</li>
                                    </ul>
                                    <div class="agent-footer p-top-10 p-right-15 p-bottom-10">
                                        <ul class="social-icons">
                                            <li>
                                                <a class="btn btn-base rounded-0 btn-sm" href="#"><i class="fa fa-facebook"></i></a>
                                            </li>
                                            <li>
                                                <a class="btn btn-base rounded-0 btn-sm" href="#"><i class="fa fa-instagram"></i></a>
                                            </li>
                                            <li>
                                                <a class="btn btn-base rounded-0 btn-sm" href="#"><i class="fa fa-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a class="btn btn-base rounded-0 btn-sm" href="#"><i class="fa fa-google-plus"></i></a>
                                            </li>
                                            <li>
                                                <a class="btn btn-base rounded-0 btn-sm" href="#"><i class="fa fa-linkedin"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12 col-sm-12 p-top-15 p-bottom-15">
                                <form>
                                    <div class="form-group">
                                        <input type="text" class="form-control rounded-0 bg-light-3" placeholder="Name">
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control rounded-0 bg-light-3" placeholder="Email">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control rounded-0 bg-light-3" placeholder="Phone">
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control rounded-0 bg-light-3" rows="4" placeholder="Message"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-base rounded-0 text-bold-600 text-spacing-5 text-uppercase text-size-13 m-bottom-10 p-left-15 p-right-15" value="Submit">
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12 m-bottom-30">
                            <div class="bg-white card-body box-shadow-1 p-top-30 p-bottom-30 p-left-30 p-right-30">
                                <h3 class="text-bold-700 m-bottom-10">ABOUT ME</h3>
