...
<head>
    ...
    <title>My Bookmarks | iProperty</title>
        ...
        <div class="container">
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-8 text-center-sm text-center-md">
                    <h3 class="text-white text-uppercase text-bold-700 m-bottom-0">My Bookmarks</h3>
                </div>
            ...
            <div class="row m-bottom-30">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <ul class="">
                        ...
                        <li class="pull-left">
                            <a class="btn btn-white box-shadow-1 active box-shadow-4 hover-1 rounded-0 p-top-30 p-bottom-30 p-left-30 p-right-30 m-right-4" href="my-bookmarks.php">
                ...
                <table class="table table-responsive">
                    ...
                    <tbody>
                        <tr class="valign-middle">
                            ...
                            <td>
                                <a class="btn btn-sm btn-danger text-size-11 text-uppercase text-bold-700 p-top-5 p-bottom-5 p-left-10 p-right-10 rounded-0" href="#"><i class="fa fa-remove"></i> Remove</a>
                            </td>
                        </tr>
                        <tr class="valign-middle">
                            <td class="width-150">
