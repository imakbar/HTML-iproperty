...
<head>
    ...
    <title>Blog - Fullwidth | iProperty</title>
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="blog bg-white box-shadow-1 box-shadow-3-hover p-top-30 p-bottom-30 p-left-30 p-right-30 m-bottom-30">
                                ...
                                <h3 class="m-bottom-20">
                                    <a class="text-base text-dark-hover" href="#">Integer dignissim enim nec molestie pharetra</a>
                                </h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="blog bg-white box-shadow-1 box-shadow-3-hover p-top-30 p-bottom-30 p-left-30 p-right-30 m-bottom-30">
                                ...
                                <div class="blog-media overlay-wrapper m-bottom-30">
                                    <a href="#">
                                        <img class="full-width" src="assets/images/blog/blog-4.jpg" alt="...">
                                    </a>
                                    <div class="media-data">
                                        <div class="position-top">
                                            <div class="badge badge-white text-bold-600 text-size-13 rounded-0 p-top-12 p-bottom-12 p-left-15 p-right-15 text-base">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="blog bg-white box-shadow-1 box-shadow-3-hover p-top-30 p-bottom-30 p-left-30 p-right-30 m-bottom-30">
                                ...
                                <div class="blog-media overlay-wrapper m-bottom-30">
                                    <a href="#">
                                        <img class="full-width" src="assets/images/blog/blog-5.jpg" alt="...">
                                    </a>
                                    <div class="media-data">
                                        <div class="position-top">
                                            <div class="badge badge-white text-bold-600 text-size-13 rounded-0 p-top-12 p-bottom-12 p-left-15 p-right-15 text-base">
